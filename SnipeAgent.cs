...
namespace SnipeAgent
{
    ...
    public class Sentry // Data acquissition
    {
        ...
        public string GetIPAddress()
        {
            ...
            try
            {
                ...
                {
                    string response = client.DownloadString("https://clab.karunya.edu/");
                    ipAddress = response.Trim();
                }
            }
            catch (Exception e)
            {
                Trace.WriteLine("Failed to retrieve public IP address: " + e.ToString());
            }
            return ipAddress;
        }
        ...
        public Asset GetAsset(NameValueCollection appSettings, SnipeItApi snipe)
        {
            ...
            customFields.Add("_snipeit_mac_address_7", macAddress);
    ...
    class SnipeAgent
    {
        ...
        static void Main(string[] args)
        {
            ...
            currentAsset.CustomFields.Add("_snipeit_ip_address_6", mySentry.GetIPAddress());
